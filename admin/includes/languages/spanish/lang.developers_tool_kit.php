...
$define = [
    ...
    'TEXT_LANGUAGE_LOOKUP_CURRENT_CATALOG_TEMPLATE' => 'Todos los archivos de idioma seleccionados actualmente - ' . DIR_WS_CATALOG . DIR_WS_LANGUAGES . '/*.php' . '/*.php',
    ...
    'TEXT_LANGUAGE_LOOKUP_CURRENT_ADMIN_LANGUAGE' => 'Todos los archivos de idioma seleccionados - Admin (' . DIR_WS_ADMIN . DIR_WS_LANGUAGES . '/*.php)' . '/*.php)',
    ...
    'TEXT_ALL_FILES_LOOKUP_CURRENT_LARAVEL' => 'Todos los archivos - Laravel',
    ...
    'TEXT_INCLUDE_PLUGINS' => 'Incluir Plugins?',
    'TEXT_INCLUDE_LARAVEL' => '¿Añadir carpeta Laravel?',
