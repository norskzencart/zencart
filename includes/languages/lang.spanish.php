...
// Definitions that require references to other definitions
    ...
    $define['ERROR_NO_INVALID_REDEEM_GV'] = ' Invalido' . $define['TEXT_GV_NAME'] . ' ' . $define['TEXT_GV_REDEEM'];
    ...
    $define['TEXT_AVAILABLE_BALANCE'] = 'Su cuenta ' . $define['TEXT_GV_NAME'] . ' Account';
